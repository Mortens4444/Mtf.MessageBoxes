namespace Mtf.MessageBoxes.Enums
{
    public enum SystemErrorCodes
    {
        ...
        /// <summary>The version of %1 is not compatible with the version you're running. Check your computer's system information to see whether you need a x86 (32-bit) or x64 (64-bit) version of the program, and then contact the software publisher.</summary>
        ...
        /// <summary>Internal OFS status codes indicating how an allocation operation is handled. Either it is retried after the containing node is moved or the extent stream is converted to a large stream.</summary>
        ...
        /// <summary>{Invalid DLL Entry point} The dynamic link library %hs is not written correctly. The stack pointer has been left in an inconsistent state. The entry point should be declared as WINAPI or STDCALL. Select YES to fail the DLL load. Select NO to continue execution. Selecting NO may cause the application to operate incorrectly.</summary>
        ERROR_BAD_DLL_ENTRYPOINT = 609,

        /// <summary>{Invalid Service Callback Entry point} The %hs service is not written correctly. The stack pointer has been left in an inconsistent state. The callback entry point should be declared as WINAPI or STDCALL. Selecting OK will cause the service to continue operation. However, the service process may operate incorrectly.</summary>
        ...
        /// <summary>A Machine Check Error has occurred. Please check the system event log for additional information.</summary>
        ...
        /// <summary>The requested files operation failed because the storage policy blocks that type of file. For more information, contact your system administrator.</summary>
        ...
        /// <summary>A handle is in an invalid state.</summary>
        ...
        /// <summary>The remote procedure call was canceled.</summary>
        ...
        /// <summary>The file is currently not available for use on this computer.</summary>
        ...
        /// <summary>An quorum of cluster nodes was not present to form a cluster.</summary>
        ...
        /// <summary>A new node cannot be added since this cluster is already at its maximum number of nodes.</summary>
        ERROR_CLUSTER_MAX_NODES_IN_CLUSTER = 5934,

        /// <summary>This cluster cannot be created since the specified number of nodes exceeds the maximum allowed limit.</summary>
        ...
        /// <summary>The Security Descriptor must explicitly grant full control to the Builtin Administrators group.</summary>
        ERROR_CLUSTER_INVALID_SECURITY_DESCRIPTOR = 5946,

        /// <summary>There is one or more shared volumes resources configured in the cluster. Those resources needs to be moved to available storage in order for operation to succeed.</summary>
        ...
        /// <summary>Implicit transactions are not supported.</summary>
        ...
        /// <summary>The replication remote procedure call was canceled.</summary>
        ...
        /// <summary>Security Accounts Manager initialization failed because of the following error: %1. Error Status: 0x%2. Please shut down this system and reboot into Directory Services Restore Mode. Check the event log for more detailed information.</summary>
        ...
        /// <summary>Operation not allowed on a disabled cross reference.</summary>
        ...
        /// <summary>The directory service detected a child partition below the requested new partition name. The partition hierarchy must be created in a top down method.</summary>
        ...
        /// <summary>Packet was received on an IPsec SA that doesn't match the packet characteristics.</summary>
        ...
        /// <summary>The application has failed to start because its side-by-side configuration is incorrect. Please see the application event log or use the command-line sxstrace.exe tools for more detail.</summary>
        ...
        /// <summary>The xpath expression exceeded supported complexity. Please simplify it or split it into two or more simple expressions.</summary>
        ...
        /// <summary>The message identifier for the desired message could not be found.</summary>
        ...
        /// <summary>The event definition could not be found for the event identifier (%1).</summary>
        ...
        /// <summary>The channel at index %1!d! of the query cannot be opened.</summary>
        ...
        /// <summary>The log of the subscription is in disabled state, and cannot be used to forward events. The log must first be enabled before the subscription can be activated.</summary>
        ...
        /// <summary>User stop resource enumeration.</summary>
        ...
        /// <summary>The monitor does not comply with the MCCS specification it claims to supports.</summary>
        ...
        /// <summary>The monitor returned an invalid monitor technology type. CRT, Plasma, and LCD (TFT) are examples of monitor technology types. This error implies that the monitor violated the MCCS 2.0 or the MCCS 2.0 Revision 1 specification.</summary>
        ERROR_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED = 15206,

        /// <summary>The caller of SetMonitorColorTemperature specified a color temperature that the current monitor did not support. This error implies that the monitor violated the MCCS 2.0 or the MCCS 2.0 Revision 1 specification.</summary>
